...
CRC is OpenShift, so this is a much lighter conversion than apps/nerc-migration/20-convert-manifests.py
...
def main():
    ...
    if not os.path.isdir(raw):
        print(f"ERROR: no raw exports at {raw}. Run apps/nerc-migration/10-export-nerc.sh first.")
        sys.exit(1)
