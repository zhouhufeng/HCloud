#!/usr/bin/env bash
# Mac Studio · CRC/OpenShift flavour · 18 — copy PVC data from NERC pods to local CRC PVCs.
#
# Prereqs done before running this:
#   - Local CRC cluster up (scripts 10-11 finished)
#   - Migrated manifests applied (platform/mac/crc/17-migrate-to-crc.py + oc apply)
...
#   bash platform/mac/crc/18-rsync-nerc-data.sh <namespace> [pvc-name ...]
